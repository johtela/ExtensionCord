...
sauce that makes a class support collection initializers is to make the class 
implement IEnumerable and then define the `Add` method in it. If these two 
things are implemented, you can initialize your collection in the same way 
as built-in collection types.
